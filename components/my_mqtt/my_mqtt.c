...
static void send_binary(esp_mqtt_client_handle_t client)
{
    ...
    int binary_size = MIN(2000, partition->size);
...
static void mqtt_app_start(void)
{
    const esp_mqtt_client_config_t mqtt_cfg = {
        .broker = {
            ...
            .address.uri = "mqtts://d8c8dcf0.ala.cn-hangzhou.emqxsl.cn:8883",
            .verification.certificate = (const char *)mqtt_eclipseprojects_io_pem_start},
        .credentials = {
            .username = "vv96",
            .authentication.password = "88888888",
        },
    };
...
void send_mqtt_message(esp_mqtt_client_handle_t client, const char* topic, const char* message) {
    ...
    if (msg_id != -1) {
        ESP_LOGI("MQTT", "Message sent with ID: %d", msg_id);
    } else {
